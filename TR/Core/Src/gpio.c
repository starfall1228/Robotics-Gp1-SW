...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SIDE_CYL_2_Pin|SIDE_CYL_Pin|ELEVATING_Pin|GRIPPER_Pin
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin PCPin */
  GPIO_InitStruct.Pin = SIDE_CYL_2_Pin|SIDE_CYL_Pin|ELEVATING_Pin|GRIPPER_Pin
